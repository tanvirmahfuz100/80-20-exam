...
const srcDir = 'D:\\Tanvir Mahfuz\\80-20-exam\\docs\\web\\ssc-finance';
const outDir = 'D:\\Tanvir Mahfuz\\80-20-exam\\public\\ssc\\finance';
...
function extractQuestions(html, source) {
  ...
  for (const block of blocks) {
    ...
    while ((btnMatch = btnRegex.exec(gridContent)) !== null && optIdx < 4) {
      ...
      const pR = /<p[^>]*>([\s\S]*?)<\/p>/g;
      let pm;
      while ((pm = pR.exec(btnMatch[0])) !== null) {
