...
const EXAM_SUBJECTS = {
  'SSC-Science':  ['বাংলা', 'ইংরেজি', 'গণিত',      'পদার্থবিদ্যা', 'রসায়ন',     'জীববিদ্যা',   'আইসিটি',   'কৃষি শিক্ষা'],
  'SSC-Business': ['বাংলা', 'ইংরেজি', 'গণিত',      'হিসাববিজ্ঞান', 'ফিন্যান্স',  'ব্যবসায় উদ্যোগ', 'আইসিটি', 'সাধারণ বিজ্ঞান', 'কৃষি শিক্ষা'],
  'SSC-Arts':     ['বাংলা', 'ইংরেজি', 'গণিত',      'ইতিহাস',      'ভূগোল',      'নাগরিকতা',   'আইসিটি',   'সাধারণ বিজ্ঞান', 'কৃষি শিক্ষা'],
