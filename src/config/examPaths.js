...
const EXAM_SUBJECTS = {
  'SSC-Science':  ['বাংলা', 'ইংরেজি', 'গণিত',      'পদার্থবিদ্যা', 'রসায়ন',     'জীববিদ্যা'],
  'SSC-Business': ['বাংলা', 'ইংরেজি', 'গণিত',      'হিসাববিজ্ঞান', 'ফিন্যান্স',  'ব্যবসায় উদ্যোগ'],
  'SSC-Arts':     ['বাংলা', 'ইংরেজি', 'গণিত',      'ইতিহাস',      'ভূগোল',      'নাগরিকতা'],
