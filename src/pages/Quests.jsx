    ...
    <div className="max-w-lg mx-auto">
            ...
            <div key={i} className="bg-background rounded-xl p-3.5">
              <div className="flex items-center gap-3">
                ...
                <div className="text-right shrink-0">
                  <p className="text-xs font-black text-text">+{quest.xp}</p>
                  <p className="text-[10px] text-text-muted font-bold flex items-center gap-0.5 justify-end mt-0.5">
      ...
      <div className="bg-gradient-to-br from-primary/5 to-peacock/5 border border-primary/20 rounded-2xl p-4 md:p-5 mb-4">
        ...
        <div className="bg-surface/80 rounded-xl p-3.5 border border/50">
          <p className="font-bold text-sm text-text mb-2">৩টি লেসন শেষ করো</p>
          <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-3 mt-3">
            ...
            <span className="text-xs font-black text-text">+৫০ এক্সপি</span>
