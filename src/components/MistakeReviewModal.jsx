    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/85 p-4">
      <div className="w-full max-w-lg bg-background border border-white/10 rounded-[2rem] shadow-2xl overflow-hidden">
        <div className="flex items-center justify-between p-6 border-b border-white/5">
          <div>
            <h2 className="text-white font-black italic tracking-tighter text-xl">Mistake Review</h2>
        ...
        <div className="p-6 max-h-[60vh] overflow-y-auto space-y-4">
          {groups.map((group) => (
            <div key={group.stage} className="bg-surface border border-white/5 rounded-2xl p-5 transition-all hover:border-white/10">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-white font-black text-sm">{group.label}</p>
                ...
                <div className="text-right">
                  <p className="text-white font-black text-lg">
                    ...
                    <span className="text-white/30">/{group.total}</span>
                  </p>
          ...
          {totalMistakes === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-white/10 text-xs mt-2 font-medium">Keep practicing to build your review queue</p>
            </div>
          )}
        </div>
