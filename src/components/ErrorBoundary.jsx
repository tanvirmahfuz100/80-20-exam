...
export default class ErrorBoundary extends Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="max-w-md mx-auto p-6 md:p-10 mt-10 bg-surface border border-white/10 rounded-2xl md:rounded-[2rem] text-center shadow-lg">
          ...
          <h3 className="text-white font-black text-xl md:text-2xl tracking-tighter mb-3">Something went wrong</h3>
